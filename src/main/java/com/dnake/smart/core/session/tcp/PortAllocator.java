...
//				break;
//			}
//			list.forEach(UDPPortManager::receive);
//			cursor += Config.BATCH_FETCH_SIZE;
//		}
//
//		StringBuilder builder = new StringBuilder();
//		builder.receive("加载完毕:\n");
//		builder.receive("----------------------------------\n");
//		PORT_MAP.forEach((ip, map) -> builder.receive("ip[").receive(ip).receive("]下有[").receive(map.size()).receive("]个端口正被使用\n"));
//		builder.receive("----------------------------------\n");
...
//	private static void receive(UDPRecord record) {
